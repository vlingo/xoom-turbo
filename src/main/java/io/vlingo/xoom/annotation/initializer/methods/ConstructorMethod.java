...
public class ConstructorMethod {
    ...
    private MethodSpec build() {
        ...
        final Object[] initializationAwareClass =
                InitializationAwareClassResolver.resolve(basePackage, elements, bootstrapClass);

        final Map.Entry<String, Object[]> resourcesStatement =
                ResourcesStatementResolver.resolve(elements, bootstrapClass);

        final Map.Entry<String, Object[]> stageInstanceStatement =
