...
import static io.vlingo.xoom.turbo.annotation.codegen.template.AnnotationBasedTemplateStandard.REST_RESOURCE;
...
public class RestResource {
  ...
  public static List<RestResource> from(final List<Content> contents) {
    final Set<String> classNames =
            ContentQuery.findClassNames(contents, REST_RESOURCE, AUTO_DISPATCH_RESOURCE_HANDLER);
