...
import static io.vlingo.xoom.turbo.annotation.codegen.TemplateParameter.ADAPTER_NAME;
import static io.vlingo.xoom.turbo.annotation.codegen.TemplateParameter.SOURCE_NAME;
...
public class Adapter {
  ...
  public static List<Adapter> from(final List<TemplateData> templatesData) {
    final Predicate<TemplateData> filter =
            templateData -> templateData.hasStandard(AnnotationBasedTemplateStandard.ADAPTER);
