...
public enum StorageType {
  ...
  public Set<String> findPersistentQualifiedTypes(final Model model, final List<Content> contents) {
    if (model.isQueryModel() || isStateful()) {
      final TemplateStandard typeStandard = model.isQueryModel() ? AnnotationBasedTemplateStandard.DATA_OBJECT : AnnotationBasedTemplateStandard.AGGREGATE_STATE;
