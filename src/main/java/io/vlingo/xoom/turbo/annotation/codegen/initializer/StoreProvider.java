...
import static io.vlingo.xoom.turbo.annotation.codegen.TemplateParameter.MODEL;
import static io.vlingo.xoom.turbo.annotation.codegen.TemplateParameter.STORAGE_TYPE;
...
public class StoreProvider {
  ...
  private StoreProvider(final StorageType storageType,
    ...
    this.className = AnnotationBasedTemplateStandard.STORE_PROVIDER.resolveClassname(parameters);
  ...
  private String resolveArguments(final Model model,
    ...
    final String projectionDispatcher =
            AnnotationBasedTemplateStandard.PROJECTION_DISPATCHER_PROVIDER.resolveClassname() + ".using(grid.world().stage()).storeDispatcher";
