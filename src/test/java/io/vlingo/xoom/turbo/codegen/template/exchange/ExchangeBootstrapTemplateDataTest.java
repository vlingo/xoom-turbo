...
public class ExchangeBootstrapTemplateDataTest {
    ...
    public void testThatTemplateParametersAreMapped() {
        ...
        Assert.assertEquals("new AuthorConsumerAdapter(\"vlingo:xoom:io.vlingo.xoom.otherapp:OtherAggregateRemoved:0.0.3\")", schemaRemovedCovey.getAdapterInstantiation());
