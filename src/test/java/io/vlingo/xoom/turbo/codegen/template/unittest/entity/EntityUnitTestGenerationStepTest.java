...
public class EntityUnitTestGenerationStepTest {
  ...
  public void testThatSourcedEntitiesUnitTestsAreGenerated() throws IOException {
    ...
    Assert.assertTrue(authorEntityTest.contains(TextExpectation.onJava().read("sourced-author-entity-test")));
    Assert.assertTrue(bookEntityTest.contains(TextExpectation.onJava().read("sourced-book-entity-test")));
    Assert.assertTrue(mockDispatcher.contains(TextExpectation.onJava().read("event-based-mock-dispatcher")));
  }
  ...
  public void testThatStatefulEntitiesWithEventBasedProjectionUnitTestsAreGenerated() throws IOException {
    ...
    Assert.assertEquals(6, context.contents().size());
    Assert.assertTrue(authorEntityTest.contains(TextExpectation.onJava().read("stateful-author-entity-test-with-event-based-projection")));
    Assert.assertTrue(bookEntityTest.contains(TextExpectation.onJava().read("stateful-book-entity-test-with-event-based-projection")));
    Assert.assertTrue(mockDispatcher.contains(TextExpectation.onJava().read("event-based-mock-dispatcher")));
  }
  ...
  public void testThatStatefulEntitiesWithOperationBasedProjectionUnitTestsAreGenerated() throws IOException {
    ...
    Assert.assertEquals(6, context.contents().size());
    Assert.assertTrue(authorEntityTest.contains(TextExpectation.onJava().read("stateful-author-entity-test-with-operation-based-projection")));
    Assert.assertTrue(bookEntityTest.contains(TextExpectation.onJava().read("stateful-book-entity-test-with-operation-based-projection")));
    Assert.assertTrue(mockDispatcher.contains(TextExpectation.onJava().read("operation-based-mock-dispatcher")));
  }
  ...
  public void testThatQueriesUnitTestGenerationShouldProcess() {
    ...
    Assert.assertTrue(new QueriesUnitTestGenerationStep().shouldProcess(context));
  }
  ...
  public void testThatQueriesUnitTestGenerationShouldNotProcess() {
    ...
    Assert.assertFalse(new QueriesUnitTestGenerationStep().shouldProcess(context));
  }
