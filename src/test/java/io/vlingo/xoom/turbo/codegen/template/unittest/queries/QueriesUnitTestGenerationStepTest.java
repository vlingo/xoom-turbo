...
public class QueriesUnitTestGenerationStepTest {
  ...
  public void testThatQueriesUnitTestAreGenerated() throws IOException {
    ...
    Assert.assertTrue(authorQueriesTest.contains(TextExpectation.onJava().read("author-queries-unit-test")));
    Assert.assertTrue(bookQueriesTest.contains(TextExpectation.onJava().read("book-queries-unit-test")));
  }
